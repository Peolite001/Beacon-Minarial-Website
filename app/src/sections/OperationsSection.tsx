  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[5] flex flex-col justify-center px-[6vw]">
        ...
        <div 
          ref={lineRef}
          className="gold-line w-[32vw] mb-6"
          style={{ marginTop: '4vh' }}
        />
        ...
        <h2 
          ref={headlineRef}
          className="headline-section text-beacon-white max-w-[56vw] mb-6"
        >
        ...
        >
          On-site CIP plant, proven recoveries, and a team that continuously improves throughput—without compromising safety.
        </p>

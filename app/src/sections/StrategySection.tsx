  ...
  return (
    ...
    >
      ...
      <img 
        ...
        alt="Mining infrastructure landscape"
        className="bg-image"
      />
      ...
      <div className="absolute inset-0 z-[5] flex flex-col justify-center px-[6vw]">
        ...
        <div 
          ref={lineRef}
          className="gold-line w-[36vw] mb-6"
          style={{ marginTop: '4vh' }}
        />
        ...
        <h2 
          ref={headlineRef}
          className="headline-section text-beacon-white max-w-[58vw] mb-6"
        >
        ...
        >
          We fund exploration from cash flow, expand capacity with discipline, and target a 10-year mine life—plus new discoveries.
        </p>

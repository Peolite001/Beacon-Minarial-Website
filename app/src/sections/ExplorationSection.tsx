...
const ExplorationSection = () => {
  ...
  return (
    ...
    >
      ...
      <img 
        ref={bgRef}
        src="/exploration_terrain.jpg" 
        alt="Exploration terrain"
        className="bg-image"
      />
      ...
      <div className="absolute inset-0 z-[5] flex flex-col justify-center px-[6vw]">
        ...
        <div 
          ref={lineRef}
          className="gold-line w-[34vw] mb-6"
          style={{ marginTop: '4vh' }}
        />
        ...
        >
          We target high-confidence, near-mine targets—testing ideas quickly, drilling responsibly, and building resources that matter.
        </p>
